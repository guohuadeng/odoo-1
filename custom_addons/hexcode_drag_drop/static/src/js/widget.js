odoo.define('hexcode_drag_drop.form_widgets', function (require) {
    "use strict";
        ...
        render_value: function () {
            ...
            this.read_name_values().then(function (ids) {
                ...
                $('.dragndrop_dec_edoc_type').on('change',function(){
                    ...
                    var model = new Model("ir.attachment");
                    model.call("attachment_update_dec_edoc_type", [],{ id: id_attachment, dec_edoc_type: dec_edoc_type}).then(function(result_id) {
