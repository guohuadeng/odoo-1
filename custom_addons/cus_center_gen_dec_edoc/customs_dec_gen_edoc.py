...
class GenEdoc(models.Model):
    _inherit = 'cus_center.customs_dec'

    @api.multi
    def gen_dec_edocs(self):
        self.env['report'].get_pdf([self.id],"cus_center.report_customs_dec_edoc_packing_list_template"), 'pdf'
        self.env['report'].get_pdf([self.id], "cus_center.report_customs_dec_edoc_invoice_template"), 'pdf'
        self.env['report'].get_pdf([self.id], "cus_center.report_customs_dec_edoc_contract_template"), 'pdf'
        self.env['report'].get_pdf([self.id], "cus_center.report_customs_dec_edoc_attorney_template"), 'pdf'
