...
class import_customs_dec_goods_list_wizard(models.TransientModel):
    ...
    def create_goods_list(self, values):
        ...
        customs_dec_brw = self.env['cus_center.customs_dec'].browse(self._context.get('active_id'))
        ...
        if goods_classification_exist_obj:
            ...
            manual_sn = goods_classification_exist_obj.ManualSN
        ...
        self.env['cus_center.dec_goods_list'].create({
            'customs_dec_id': customs_dec_brw.id,
