...
GENERATE_WLY_TO_EX_SINGLE_PATH = config.options.get('generate_wly_to_ex_single_path',
                                                    MAIN_PATH + '/about_wly_xml_data/post_ex_client/send_wly_to_ex_single')
GENERATE_WLY_TO_EX_QP_PATH = config.options.get('generate_wly_to_ex_qp_path',
                                                MAIN_PATH + '/about_wly_xml_data/post_ex_client/send_wly_to_ex_qp')

SEND_WLY_TO_EX_SINGLE_ATTACH = config.options.get('generate_wly_to_ex_single_attach_path',
                                                  MAIN_PATH + '/about_wly_xml_data/post_ex_client/send_wly_to_ex_single_attach')

SEND_WLY_TO_EX_QP_ATTACH = config.options.get('generate_wly_to_ex_qp_attach_path',
                                              MAIN_PATH + '/about_wly_xml_data/post_ex_client/send_wly_to_ex_qp_attach')
...
def send_customs_dec_edoc_xml_to_ex(self):
    ...
    for attach in self.information_attachment_ids:
        ...
        attach_edoc_type = attach.dec_edoc_type if attach.dec_edoc_type else ""  # 随附单据类型
        ...
        if attach_name and attach_data:
            ...
            # 单一窗口报文发送根目录
            base_dir_send_single_attach = SEND_WLY_TO_EX_SINGLE_ATTACH
            # QP 报文发送根目录
            base_dir_send_qp_attach = SEND_WLY_TO_EX_QP_ATTACH
