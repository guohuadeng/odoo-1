odoo.define("dashboard_projects.project_management_dashboard", function(require) {
    ...
    var project_dashboard = Widget.extend({
        ...
        get_chart_employee_timesheet:function(e){
            ...
            var project_management_dashboard = new Model('project.management.dashboard');
            var project_id = $("#projects_selectbox").val();
            project_management_dashboard.call('get_chart_employee_timesheet',[project_id,]).then(function(data){
        ...
        get_chart_project_timesheet:function(e){
            ...
            var project_management_dashboard = new Model('project.management.dashboard');
            var project_id = $("#projects_selectbox").val();
            project_management_dashboard.call('get_chart_project_timesheet',[project_id,]).then(function(data){
        ...
        get_chart_employee_task:function(e){
            ...
            var project_management_dashboard = new Model('project.management.dashboard');
            var project_id = $("#projects_selectbox").val();
            project_management_dashboard.call('get_chart_employee_tasks',[project_id,]).then(function(data){
        ...
        get_chart_project_task:function(e){
            ...
            var project_management_dashboard = new Model('project.management.dashboard');
            var project_id = $("#projects_selectbox").val();
            project_management_dashboard.call('get_chart_project_tasks',[project_id,]).then(function(data){
        ...
        get_chart_employee_issue:function(e){
            ...
            var project_management_dashboard = new Model('project.management.dashboard');
            var project_id = $("#projects_selectbox").val();
            project_management_dashboard.call('get_chart_employee_issues',[project_id,]).then(function(chart_employee_issues){
        ...
        get_chart_project_issue:function(e){
            ...
            var project_management_dashboard = new Model('project.management.dashboard');
            var project_id = $("#projects_selectbox").val();
            project_management_dashboard.call('get_chart_project_issues',[project_id,]).then(function(chart_project_issues){
        ...
        start: function(){
            var self = this;
            var project_management_dashboard = new Model('project.management.dashboard');
            project_management_dashboard.call('get_all_projects',[[]]).done(function(projects){
        ...
        fetchblocks : function(project_id){
            ...
            var project_management_dashboard = new Model('project.management.dashboard');
            project_management_dashboard.call('get_projects_dashboard_data',[project_id,]).then(function(projects){
