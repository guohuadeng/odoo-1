...
class project_management_dashboard(models.Model):
    ...
    def get_total_clients(self,project_id):
        self.env.cr.execute("select count(distinct partner_id) FROM project_project join account_analytic_account on account_analytic_account.id = analytic_account_id")
