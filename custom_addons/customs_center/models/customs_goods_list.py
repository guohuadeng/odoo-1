...
class CusGoodsList(models.Model):
    ...
    CodeTS = fields.Char(string="Code TS", required=False, )  # 商品编码
    ...
    deal_unit_price = fields.Monetary(string="deal unit price", )    # 成交单价
    deal_unit = fields.Char(string="deal unit", required=False, )    # 成交单位
