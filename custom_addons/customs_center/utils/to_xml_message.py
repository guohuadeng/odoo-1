...
def delegate_to_xml(self):
    ...
    # 单一窗口报文发送根目录
    base_dir_send_single = config.options.get('generate_wly_to_ex_single_path', '/home/saastest/xml_data/about_wly_xml_data/post_ex_client/send_wly_to_ex_single')
    # QP 报文发送根目录
    base_dir_send_qp = config.options.get('generate_wly_to_ex_qp_path', '/home/saastest/xml_data/about_wly_xml_data/post_ex_client/send_wly_to_ex_qp')
